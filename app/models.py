...
class AIMemory(Base):
    ...
    source_type = Column(String(30), nullable=False, default="manual")  # issue/pr/conversation/manual/code_structure/docs/report/slack
...
class Comment(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    target_type = Column(String(20), nullable=False)   # 'report'
